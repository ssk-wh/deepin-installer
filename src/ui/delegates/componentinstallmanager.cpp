...
QPair<QString, QString> ComponentInstallManager::updateTs(const QString& id) const {
    ...
    {"core", {tr("Core"), tr("Core packages for server OS.")}},
    {"base", {tr("Base"), tr("Base packages for server OS.")}},
    {"Basic-Server-Environment", {tr("Basic Server Environment"), tr("Applies to standard common service environments, such as Web services and database services.")}},
    {"Cloud-and-Virtualzalition", {tr("Cloud and Virtualzalition"), tr("Applies to IaaS environments, such as virtualization, containers, and clouds.")}},
    {"Big-Data", {tr("Big Data"), tr("Applies to servers that provide parallel processing of massive data.")}},
    {"Server-Environment-with-GUI", {tr("Server Environment with GUI"), tr("Operates the services and applications on the graphical user interface.")}},
    {"Custom-Installation", {tr("Custom Installation"), tr("Provides most package groups for custom selection, covering minimum to maximum installation.")}},
    {"debugging-tools", {tr("Debugging Tools"), tr("Provide debugging package for program function and performance.")}},
    {"deepin", {tr("Applications with GUI"), tr("Commonly used server application packages in graphical user interface.")}},
    {"development-tools", {tr("Development Tools"), tr("Development tool packages in multiple programming languages.")}},
    {"directory-client", {tr("Directory Client"), tr("Clients for integration into a network managed by a directory service.")}},
    {"dns-server", {tr("Domain Name Service"), tr("Environments for running the domain name service (DNS).")}},
    {"file-server", {tr("File and Storage Server"), tr("CIFS, SMB, NFS, iSCSI, iSER, and iSNS network storage server.")}},
    {"graphics", {tr("Graphics Creation Tools"), tr("Software for creating and editing images.")}},
    ...
    {"network-file-system-client", {tr("Network File System Client"), tr("Environments for network storage devices.")}},
    {"performance-tools", {tr("Performance Tools"), tr("Packages for monitoring and diagnosing hardware devices, system programs, and applications.")}},
    {"security-tools", {tr("Security Tools"), tr("Packages for integrity and trust verification.")}},
    {"web-server", {tr("Web Server"), tr("Provides Java servelets and Web common service components.")}},
    ...
    {"virtualization-platform", {tr("Virtualization Platform"), tr("Provides an interface for acessing and controlling virtualized guests and containers.")}},
